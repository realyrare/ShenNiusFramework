...
namespace ShenNiusSystem.Core.Model.Cms
{
    ...
    public class Article 
    {
        ...
        /// <summary>
        /// Desc:手机端展示形式  0=左右    1=下大图  2=下3个小图
        /// Default:0
        /// Nullable:False
        /// </summary>
        public int WapType { get; set; } = 0;
        ...
        public List<ArticleImageJson> ImgUrl {get;set;}=new List<ArticleImageJson>();
